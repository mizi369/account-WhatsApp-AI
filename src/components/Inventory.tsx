      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-xs font-bold hover:bg-white/10 transition-all text-slate-300"
          >
            <Printer size={14} />
            Cetak Laporan
          </button>
            ...
            >
              ...
              <form onSubmit={handleSave} className="p-6 space-y-6">
                ...
                <div className="p-4 bg-secondary/10 border border-secondary/20 rounded-2xl flex items-center justify-between">
                  ...
                  <button type="submit" className="px-6 py-2.5 bg-primary text-white rounded-xl font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:bg-primary/90 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 text-xs">
                    <Save size={16} />
