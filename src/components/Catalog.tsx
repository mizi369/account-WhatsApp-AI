      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-lg text-xs font-bold hover:bg-indigo-500/20 active:scale-95 transition-all text-indigo-400"
          >
            <RefreshCw size={14} />
            Muat Contoh
          </button>
          <button 
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-lg text-xs font-bold hover:bg-emerald-500/20 active:scale-95 transition-all text-emerald-400"
          >
            <Save size={14} />
            Simpan Katalog
          </button>
          <button 
            onClick={handlePrint}
            className="flex items-center gap-2 px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-xs font-bold hover:bg-white/10 active:scale-95 transition-all text-slate-300"
          >
            <Printer size={14} />
            Cetak PDF
          </button>
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-1.5 bg-primary text-white rounded-lg text-xs font-black shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition-all uppercase tracking-tight"
          >
            <Plus size={14} />
            Tambah Produk
          </button>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <form onSubmit={handleAddItem} className="p-6 space-y-4">
                ...
                <button type="submit" className="w-full py-2.5 bg-primary text-white rounded-xl font-black shadow-lg shadow-primary/20 hover:bg-primary/90 hover:scale-[1.02] active:scale-[0.98] transition-all mt-4 text-xs uppercase tracking-widest">
                  Simpan Katalog
                </button>
              </form>
            </motion.div>
